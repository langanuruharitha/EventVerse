...
export default function CakeDesigner() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      alert('Failed to generate cake design. Please try again.');
    } finally {
      setGenerating(false);
    }
  };
          ...
          {generating ? (
            ...
            <div className="relative w-full h-full">
              ...
              <button
                ...
                className="absolute bottom-4 right-4 bg-white text-pink-600 px-4 py-2 rounded-lg font-semibold shadow-lg hover:bg-gray-50 transition-colors flex items-center"
              >
